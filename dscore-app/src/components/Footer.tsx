    ...
    <footer className="border-t border-gold/15 py-9 mt-10 relative z-10 glass">
      <div className="max-w-[1200px] mx-auto px-7 flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <div className="font-mono text-[13px] text-muted tracking-[0.2em] mt-1">DEFENSIVE ANALYTICS · EST. 2026</div>
        </div>
        <div className="font-mono text-[13px] text-muted text-right leading-relaxed tracking-[0.06em]">
